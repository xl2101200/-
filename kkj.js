...
[rewrite_local]
http://console.zqfsc3a5m.store/t555 url script-request-header https://raw.githubusercontent.com/xl2101200/-/main/kkj.js

[MITM]
hostname = console.zqfsc3a5m.store
...
const kkjurlArr = [], kkjhdArr = [],kkjcount = ''
...
!(async () => {
  ...
  } else {kkjurlArr.push($.getdata('kkjurl'))
...
$.log(kkjhd)
   $.msg($.name,"",'看看集'+`${status}` +'数据获取成功！')}
}
function kkjyd(timeout = 0) {
  return new Promise((resolve) => {
t = kkjurl.match(/t=(\w+)/)[1]
let url = {
        url : `http://ydt.kxlock.com:10080/code008/ydt/reqgouc?ticket=${t}`,
