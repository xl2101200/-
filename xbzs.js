...
进入WGC → 游戏 → 小宝种树 → 种树 → 选择任意档次2wgc币 → 许愿选择你中意的商品 → 右下角逛逛 → 互动 → 初级1 → 即可获取ck
...
/////////////////////////////////////////////////
注意：
  每天都需要在23:50分前点击收获宝石！！！不然宝石会消失！
        宝石可以卖！黑市目前5000宝石=12元
         每天23：50点收获宝石都有10000宝石起！
   具体是撸钱还是撸实物你们随意，撸钱每天可以撸24元左右！
/////////////////////////////////////////////////
...
[task_local]
#小宝种树
0 0 0/2 * * * https://raw.githubusercontent.com/xl2101200/-/main/xbzs.js, tag=小宝种树, img-url=https://raw.githubusercontent.com/sngxpro/QuanX/master/icons/tom.png, enabled=true
...
let url = {
    ...
    $.log('\n获取用户id成功：'+result.data.homeUser.userId)
}else{
