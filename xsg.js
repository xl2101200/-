...
别充钱！0撸！提现没啥要求，够100就可以提了。
登入点击我的，然后点右上角每日签到获取ck

后续添加早起(睡)打卡，(早中晚)餐打卡等功能
...
[rewrite_local]
#薪时光
http://www.hbwsnl.cn/index.php? url script-request-body https://raw.githubusercontent.com/xl2101200/-/main/xsg.js

[MITM]
hostname = www.hbwsnl.cn
...
$.log(xsghd)
    $.setdata($request.body,'xsgbody')
$.log(xsgbody)
   $.msg($.name,"","薪时光获取headers成功！")
    } 
  }
...
let url = {
        url : 'http://www.hbwsnl.cn/index.php?m=HkApi&c=Api&a=index',
