...
!(async () => {
    if (typeof $request !== "undefined") {
        ...
        hbspbodyArr.push($.getdata('hbspbody'))
        ...
        for (let i = 2; i <= hbspcount; i++) {
            ...
            hbspbodyArr.push($.getdata(`hbspbody${i}`))
        }
        console.log(
...
function hbspck() {
    if ($request.url.indexOf("getGold") > -1) {
        ...
        const hbspbody = $request.body
        if (hbspbody) $.setdata(hbspbody, `hbspbody${status}`)
        $.log(hbspbody)
